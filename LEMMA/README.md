...
python lemma.py --input_file_name /home/jncsnlp4/tb/prompt-llava/FAKEDDIT.json --use_cache
python lemma.py --input_file_name /home/jncsnlp4/SSD2/tb/data/MR2-en/dataset_items_test_filtered.json --use_cache
```

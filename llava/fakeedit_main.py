...
for x in range(len(data)):
    ...
    if os.path.exists(image_path):
        ...
        # labels.append(label)
        final_real_prob = 0.4*text_real_prob.item()+0.3*image_real_prob.item()+0.3*mm_real_logits.item()
        final_fake_prob = 0.4*text_fake_prob.item()+0.3*image_fake_prob.item()+0.3*mm_fake_logits.item()

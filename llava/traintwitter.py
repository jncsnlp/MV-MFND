...
#fakeddit
with open("/home/jncsnlp4/tb/Qwen2-VL-main/train_twitter/train_data.csv",'r',encoding='utf-8') as file:
    csv_dict_reader = csv.reader(file)
    datarows = list(csv_dict_reader)


with open("/home/jncsnlp4/tb/Qwen2-VL-main/train_twitter/text_knowledge2.csv",mode='r',encoding="utf-8")as file:
    csv_dict_reader = csv.reader(file)
    text_rows = list(csv_dict_reader)


with open('/home/jncsnlp4/tb/Qwen2-VL-main/train_twitter/image_knowledge2.csv',mode='r',encoding="utf-8")as file:
    csv_dict_reader = csv.reader(file)
    image_rows = list(csv_dict_reader)


with open('/home/jncsnlp4/tb/Qwen2-VL-main/train_twitter/text_question.txt','r',encoding = 'utf-8') as file:
    text_questions = file.readlines()

with open('/home/jncsnlp4/tb/Qwen2-VL-main/train_twitter/image_question.txt','r',encoding='utf-8') as file:
    image_questions = file.readlines()



with open('/home/jncsnlp4/tb/prompt-llava/twittertrain/twitter_text_max_index.txt','r',encoding='utf-8') as file:
    text_indexs = file.read()

with open('/home/jncsnlp4/tb/prompt-llava/twittertrain/twitter_image_max_index.txt','r',encoding='utf-8') as file:
...
for x in range(len(datarows)):
    ...
    if os.path.exists(image_path):
        ...
        text_index = text_indexs[num]
        image_index = image_indexs[num]
        ...
        image_output = ""
        mm_output = ""
        if max(text_real_prob,text_fake_prob)<0.8564 :    
        ...
        if max(image_real_prob,image_fake_prob)<0.8564:
        ...
        if max(mm_real_logits,mm_fake_logits) < 0.8564 :
...
with open("twittertrain/twitter_real_logits0.8564.txt",'a',encoding='utf-8') as file:
    # real_logits = file.read()
    file.write(str(real_logits))
with open("twittertrain/twitter_fake_logits0.8564.txt",'a',encoding='utf-8') as file:
    # fake_logits = file.read()
    file.write(str(fake_logits))
with open("twittertrain/twitter_labels0.8564.txt",'a',encoding='utf-8') as file:
    # labels = file.read()

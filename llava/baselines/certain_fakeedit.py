...
with open("/home/jncsnlp4/tb/Qwen2-VL-main/fakeddit_knowledge/extra_knowledge_ours_fakeddit_top52.csv",mode='r',encoding="utf-8")as file:
...
with open('/home/jncsnlp4/tb/Qwen2-VL-main/fakeddit_knowledge/mm_knowledge_fakeddit2.csv',mode='r',encoding="utf-8")as file:
    csv_dict_reader = csv.reader(file)
    mm_rows = list(csv_dict_reader)

with open('/home/jncsnlp4/tb/Qwen2-VL-main/fakeddit_knowledge/fakeedit_text_question.txt','r',encoding = 'utf-8') as file:
    text_questions = file.readlines()

with open('/home/jncsnlp4/tb/Qwen2-VL-main/fakeddit_knowledge/fakeedit_image_question.txt','r',encoding='utf-8') as file:
    image_questions = file.readlines()

with open('/home/jncsnlp4/tb/prompt-llava/test_index/fakeddit_test_text_max_index.txt','r',encoding='utf-8') as file:
    text_indexs = file.read()

with open('/home/jncsnlp4/tb/prompt-llava/test_index/fakeddit_test_image_max_index.txt','r',encoding='utf-8') as file:
    image_indexs = file.read()

with open('/home/jncsnlp4/tb/Qwen2-VL-main/questions/mm_question_fakeddit.csv','r',encoding='utf-8') as file:
...
for x in range(len(data)):
    ...
    if os.path.exists(image_path):
        ...
        # labels.append(label)
        final_real_prob = 0.3*text_real_prob.item()+0.3*image_real_prob.item()+0.3*mm_real_logits.item()
        final_fake_prob = 0.3*text_fake_prob.item()+0.3*image_fake_prob.item()+0.3*mm_fake_logits.item()
...
# /home/jncsnlp4/tb/prompt-llava/fakeedit_fake_logits单视角——知识0.7.txt
# from mpl_toolkits.mplot3d import Axes3D
# import numpy as np
# from scipy.interpolate import griddata
# with open("fakeedit_real_logits多视角.txt",'r',encoding='utf-8') as file:
#     real_logits = file.read()
#     # file.write(str(real_logits))
# with open("fakeedit_fake_logits多视角.txt",'r',encoding='utf-8') as file:
#     fake_logits = file.read()
#     # file.write(str(fake_logits))
# with open("fakeedit_labels0.7.txt",'r',encoding='utf-8') as file:
#     labels = file.read()
#     # file.write(str(labels))
...
#     final_real_logits = 0.3*real_logits[x][0] + 0.3*real_logits[x][1] + 0.4*real_logits[x][2]
#     final_fake_logits = 0.3*fake_logits[x][0] + 0.3*fake_logits[x][1] + 0.4*fake_logits[x][2] 
#     label = labels[x]
...
# import numpy as np
# from scipy.interpolate import griddata
# with open("fakeedit_real_logits0.7.txt",'r',encoding='utf-8') as file:
#     real_logits = file.read()
#     # file.write(str(real_logits))
# with open("fakeedit_fake_logits0.7.txt",'r',encoding='utf-8') as file:
#     fake_logits = file.read()
#     # file.write(str(fake_logits))
# with open("fakeedit_labels0.7.txt",'r',encoding='utf-8') as file:
#     labels = file.read()
...
#     np.linspace(np.nanmin(ZI), 0.79, 10),     
#     np.linspace(0.79, np.nanmax(ZI), 5)      
# ])
...
# # plt.xlabel('aerfa')
# # plt.ylabel('best_f1')
# plt.savefig('fakeedit_arefa0.7.png', dpi=300)  
...
print(f"一共有{num}条数据")
with open("train_twitter/fakeedit_real_logits0.8013.txt",'a',encoding='utf-8') as file:
    # real_logits = file.read()
    file.write(str(real_logits))
with open("train_twitter/fakeedit_fake_logits0.8013.txt",'a',encoding='utf-8') as file:
    # fake_logits = file.read()
    file.write(str(fake_logits))
with open("train_twitter/fakeedit_labels0.8013.txt",'a',encoding='utf-8') as file:
    # labels = file.read()
